...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProject.project'
        db.alter_column('gtutorial_userproject', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gdesigner.Application'], null=True))

    def backwards(self, orm):

        # Changing field 'UserProject.project'
        db.alter_column('gtutorial_userproject', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(default=112, to=orm['gdesigner.Application']))
