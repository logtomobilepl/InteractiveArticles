...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AppFiles'
        db.create_table('gtutorial_appfiles', (
        ...
        db.send_create_signal('gtutorial', ['AppFiles'])


    def backwards(self, orm):
        # Deleting model 'AppFiles'
        db.delete_table('gtutorial_appfiles')
