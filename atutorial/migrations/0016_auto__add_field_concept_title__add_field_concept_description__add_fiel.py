...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Concept.title'
        db.add_column('gtutorial_concept', 'title',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Concept.description'
        db.add_column('gtutorial_concept', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Concept.mp3'
        db.add_column('gtutorial_concept', 'mp3',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Concept.video'
        db.add_column('gtutorial_concept', 'video',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Concept.image'
        db.add_column('gtutorial_concept', 'image',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Concept.title'
        db.delete_column('gtutorial_concept', 'title')

        # Deleting field 'Concept.description'
        db.delete_column('gtutorial_concept', 'description')

        # Deleting field 'Concept.mp3'
        db.delete_column('gtutorial_concept', 'mp3')

        # Deleting field 'Concept.video'
        db.delete_column('gtutorial_concept', 'video')

        # Deleting field 'Concept.image'
        db.delete_column('gtutorial_concept', 'image')
