...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('gtutorial_lesson', 'title', self.gf('django.db.models.fields.CharField')(default='Title', max_length=255))

        # Changing field 'Lesson.order'
        db.alter_column('gtutorial_lesson', 'order', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Lesson.title'
        db.alter_column('gtutorial_lesson', 'title', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Lesson.order'
        db.alter_column('gtutorial_lesson', 'order', self.gf('django.db.models.fields.IntegerField')())
