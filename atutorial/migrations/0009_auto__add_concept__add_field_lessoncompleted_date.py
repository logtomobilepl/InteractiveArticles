...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('gtutorial_concept', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('lesson', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gtutorial.Lesson'])),
            ('content', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('gtutorial', ['Concept'])

        # Adding field 'LessonCompleted.date'
        db.add_column('gtutorial_lessoncompleted', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 2, 19, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Concept'
        db.delete_table('gtutorial_concept')

        # Deleting field 'LessonCompleted.date'
        db.delete_column('gtutorial_lessoncompleted', 'date')
