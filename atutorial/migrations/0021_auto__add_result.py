...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Result'
        db.create_table('gtutorial_result', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('quiz', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gtutorial.Quiz'])),
            ('score', self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=5, decimal_places=2)),
        ))
        db.send_create_signal('gtutorial', ['Result'])


    def backwards(self, orm):
        # Deleting model 'Result'
        db.delete_table('gtutorial_result')
    ...
    models = {
        ...
        'gtutorial.result': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'quiz': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['gtutorial.Quiz']"}),
            'score': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '5', 'decimal_places': '2'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
