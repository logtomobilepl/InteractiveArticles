...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lesson.is_start_finished'
        db.add_column('gtutorial_lesson', 'is_start_finished',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Lesson.is_start_finished'
        db.delete_column('gtutorial_lesson', 'is_start_finished')
