...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LessonProject.start_project'
        db.alter_column('gtutorial_lessonproject', 'start_project_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['gdesigner.Application']))

        # Changing field 'LessonProject.end_project'
        db.alter_column('gtutorial_lessonproject', 'end_project_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['gdesigner.Application']))

    def backwards(self, orm):

        # Changing field 'LessonProject.start_project'
        db.alter_column('gtutorial_lessonproject', 'start_project_id', self.gf('django.db.models.fields.related.ForeignKey')(default=113, to=orm['gdesigner.Application']))

        # Changing field 'LessonProject.end_project'
        db.alter_column('gtutorial_lessonproject', 'end_project_id', self.gf('django.db.models.fields.related.ForeignKey')(default=113, to=orm['gdesigner.Application']))
