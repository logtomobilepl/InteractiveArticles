...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('gtutorial_promotioncode', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('subscription_package', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gtutorial.SubscriptionPackage'], null=True, blank=True)),
        ...
        db.send_create_signal('gtutorial', ['PromotionCode'])


    def backwards(self, orm):
        # Deleting model 'PromotionCode'
        db.delete_table('gtutorial_promotioncode')
