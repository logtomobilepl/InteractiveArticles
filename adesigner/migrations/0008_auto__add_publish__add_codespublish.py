...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('gdesigner_publish', (
        ...
        db.send_create_signal('gdesigner', ['Publish'])

        # Adding model 'CodesPublish'
        db.create_table('gdesigner_codespublish', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('publish_id', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ...
        db.send_create_signal('gdesigner', ['CodesPublish'])


    def backwards(self, orm):
        # Deleting model 'Publish'
        db.delete_table('gdesigner_publish')

        # Deleting model 'CodesPublish'
        db.delete_table('gdesigner_codespublish')
