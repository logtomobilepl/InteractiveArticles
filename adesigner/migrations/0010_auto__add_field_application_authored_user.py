...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Application.authored_user'
        db.add_column('gdesigner_application', 'authored_user',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Application.authored_user'
        db.delete_column('gdesigner_application', 'authored_user')
