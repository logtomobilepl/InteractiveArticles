...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PublishEmail'
        db.create_table('gdesigner_publishemail', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('publish', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gdesigner.Publish'], null=True, blank=True)),
            ('email', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('sharedCode', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('gdesigner', ['PublishEmail'])

        # Adding field 'Application.release'
        db.add_column('gdesigner_application', 'release',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'PublishEmail'
        db.delete_table('gdesigner_publishemail')

        # Deleting field 'Application.release'
        db.delete_column('gdesigner_application', 'release')
    ...
    models = {
        ...
        'gdesigner.codespublish': {
            'Meta': {'object_name': 'CodesPublish'},
            'code': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'publish_id': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
        ...
        'gdesigner.publishemail': {
            'Meta': {'object_name': 'PublishEmail'},
            'email': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'publish': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['gdesigner.Publish']", 'null': 'True', 'blank': 'True'}),
            'sharedCode': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        'gdesigner.screen': {
