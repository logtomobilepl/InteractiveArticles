...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TextEdit.font_type'
        db.add_column('gdesigner_textedit', 'font_type',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TextEdit.font_type'
        db.delete_column('gdesigner_textedit', 'font_type')
