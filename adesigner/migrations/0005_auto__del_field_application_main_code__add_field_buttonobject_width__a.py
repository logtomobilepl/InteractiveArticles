...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ButtonObject.width'
        db.add_column('gdesigner_buttonobject', 'width',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ButtonObject.height'
        db.add_column('gdesigner_buttonobject', 'height',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ButtonObject.font_size'
        db.add_column('gdesigner_buttonobject', 'font_size',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ButtonObject.font_type'
        db.add_column('gdesigner_buttonobject', 'font_type',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ButtonObject.width'
        db.delete_column('gdesigner_buttonobject', 'width')

        # Deleting field 'ButtonObject.height'
        db.delete_column('gdesigner_buttonobject', 'height')

        # Deleting field 'ButtonObject.font_size'
        db.delete_column('gdesigner_buttonobject', 'font_size')

        # Deleting field 'ButtonObject.font_type'
        db.delete_column('gdesigner_buttonobject', 'font_type')
