...
Wami.GUI = function(options) {
	var RECORD_BUTTON = 1;
	var PLAY_BUTTON = 2;
    var events = {}; // startRecording | stopRecording | startPlaying | stopPlaying
	...
	function setOptions(options) {
        if (!options.buttonUrl) {
            options.buttonUrl = "/gamedesigner/media/js/wami_recorder/buttons.png";
        }
        
        /*if (options && options.startRecording && typeof options.startRecording === "function") {
            events.startRecording = options.startRecording;
        }       
        if (options && options.stopRecording && typeof options.stopRecording === "function") {
            events.stopRecording = options.stopRecording;
        }     
        if (options && options.startPlaying && typeof options.startPlaying === "function") {
            events.startPlaying = options.startPlaying;
        }            
        if (options && options.stopPlaying && typeof options.stopPlaying === "function") {
            events.stopPlaying = options.stopPlaying;
        } */ 
	...
	function startRecording() {
        if (options.startRecording && typeof options.startRecording === "function") {
	...
	function stopRecording() {
        ...
        if (options.stopRecording && typeof options.stopRecording === "function") {
	...
	function startPlaying() {
        if (options.startPlaying && typeof options.startPlaying === "function") {
	...
	function stopPlaying() {
        if (options.stopPlaying && typeof options.stopPlaying === "function") {
            options.stopPlaying();
        }  	    
		Wami.stopPlaying();
	}
